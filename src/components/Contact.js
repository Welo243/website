...
const Contact = () =>{
    ...
    return(
        ...
        <div className="container mx-auto text-center">
            ...
            Asset static/media/fra.acb20c8fcbaf498cf1b7.png 83.4 KiB 
            emitted immutable from: src/assets/img/fra.pn auxiliary name: main
            asset static/media/bukasss.e51b1844a8b998257216.png 80.1 KiB 
            </p>
            {/* form */}
            <form className='px-8 lg:px-0 max-w-[600px] mx-auto flex flex-col space-y-6 mb-[46px] '>
                ...
                <input className='form-control' placeholder="Email adresse" type='email'  />
